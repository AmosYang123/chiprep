...
On the published site, choose **Use phone camera**, scan the QR code, take or choose a photo, then tap **Upload to computer**. Keep both pages open until the phone confirms the result. Repeat for more pages. The computer adds recognized Chinese words and pinyin to the existing list, skips duplicate words, and saves the list on that browser. Review recognition and pronunciation before studying.

The QR panel closes the connection when dismissed. Codes expire after 10 minutes; **Create new code** replaces the old connection. One phone can connect at a time. The last five received photos remain downloadable until the computer page reloads. Photos are not persisted with the word list.
